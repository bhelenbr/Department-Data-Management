...
def main(years,inputfile):
	...
	table = df.pivot_table(values=['Student'], index=['Year'], aggfunc={'Student': 'count'},observed=False)
	...
	plt.xlabel("Year")
	plt.ylabel("Theses")
	plt.savefig('Tables_dept/thesis.png',bbox_inches='tight',pad_inches=1)
	plt.close()

if __name__ == "__main__":
	parser = argparse.ArgumentParser(description='This script outputs plots of theses awards in the last [YEARS] years')
