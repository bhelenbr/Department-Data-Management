...
def main(years,inputfile):
	...
	table = df.pivot_table(values=['Rounds'], index=['Year'], aggfunc={'Rounds': 'sum'},observed=False)
	...
	plt.savefig('Tables_dept/reviews.png',bbox_inches='tight',pad_inches=1)
	plt.close()
	
if __name__ == "__main__":
	parser = argparse.ArgumentParser(description='This script outputs plots of reviewing activity in the last [YEARS] years')
